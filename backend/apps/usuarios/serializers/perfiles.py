...
class VendedorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'id', 'estado',
            'usuario', 'usuario_username', 'usuario_email', 'usuario_first_name', 'usuario_last_name',
...
class VendedorCrearSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        # Si el serializer es llamado desde un ViewSet donde el promotor se inyectó en los datos validados o context
        ...
        if not promotor:
            raise serializers.ValidationError({"promotor": "Se requiere un promotor válido para crear un vendedor."})
