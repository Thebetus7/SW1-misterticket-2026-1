...
export default function RegisterPage() {
  const [formData, setFormData] = useState({
    ...
    first_name: '',
    last_name: '',
    rol_nombre: '' // Por defecto sin rol específico
  });
    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-50 p-4">
      <div className="max-w-md w-full animate-fade-in-up py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-brand-600 mt-2">Únete a MisterTicket y disfruta sin límites</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="input-field pl-10"
                >
                  <option value="">Usuario Estándar (Comprador)</option>
                  <option value="organizador">Organizador de Eventos</option>
                  <option value="artista">Artista</option>
                  <option value="verificador">Verificador Autorizado</option>
                </select>
              </div>
            </div>
